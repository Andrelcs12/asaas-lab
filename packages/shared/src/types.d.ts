import type { CustomerSyncStatus, InternalPaymentStatus, PaymentMethod, PaymentOrderStatus, PaymentOrderType, SubscriptionCycle, SubscriptionStatus, UserRole, WebhookEventStatus } from './enums';
...
export interface PaymentProvider {
    ...
    updateCustomer(providerCustomerId: string, input: UpdateProviderCustomerInput): Promise<ProviderCustomer>;
    createPixCheckout(input: CreatePixCheckoutInput): Promise<ProviderCheckout>;
    createCreditCardCheckout(input: CreateCreditCardCheckoutInput): Promise<ProviderCheckout>;
    createRecurringCreditCardCheckout(input: CreateRecurringCheckoutInput): Promise<ProviderCheckout>;
